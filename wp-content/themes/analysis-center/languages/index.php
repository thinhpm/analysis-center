		...
		<main id="main" class="site-main">
			...
			<div class="container">
				...
				<div class="product-list">
					...
					$results = $wpdb->get_results ( "SELECT * FROM (SELECT * FROM products ORDER BY last_update) T WHERE percent > 84 AND id_web = 3 AND status = 1 ORDER BY `T`.`last_update` DESC LIMIT 100" );
