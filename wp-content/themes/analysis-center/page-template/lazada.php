...
<link rel="stylesheet" href="/wp-content/themes/analysis-center/css/voucher.css" data-minify="1">
	
<div class="store-listings st-list-coupons" style="padding: 0 50px">
	<?php 
		$lists = $wpdb->get_results ("SELECT * FROM voucher WHERE `website`='lazada'");
		$stt = 0;
							...
							<div class="store-thumb-link">
								<div class="store-thumb thumb-img">
				 					<a class="thumb-padding" href="#">
				 						<img width="300" height="150" src="https://mgg.vn/wp-content/uploads/2018/01/lazada-200x100.png" class="attachment-wpcoupon_medium-thumb size-wpcoupon_medium-thumb" alt="Mã giảm giá lazada" title="Mã giảm giá lazada" sizes="(max-width: 300px) 100vw, 300px">
				 					</a>
				 				</div>
				 			</div>
