...
<link href="<?php get_template_directory_uri().'/css/voucher.css' ?>" rel="stylesheet">

<div class="store-listings st-list-coupons" style="padding: 0 50px">
	<?php 
		$lists = $wpdb->get_results ("SELECT * FROM voucher WHERE `website`='tiki'");
		$stt = 0;
							...
							<div class="store-thumb-link">
								<div class="store-thumb thumb-img">
				 					<a class="thumb-padding" href="#">
				 						<img width="300" height="150" src="https://mgg.vn/wp-content/uploads/2018/01/tiki.png" class="attachment-wpcoupon_medium-thumb size-wpcoupon_medium-thumb" alt="Mã giảm giá tiki" title="Mã giảm giá tiki" sizes="(max-width: 300px) 100vw, 300px">
				 					</a>
				 				</div>
				 			</div>
